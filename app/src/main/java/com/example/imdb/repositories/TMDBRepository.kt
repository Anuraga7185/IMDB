...
import com.example.imdb.retrofit.email_check.EmailCheckApiServices
import com.example.imdb.retrofit.email_check.EmailCheckRetrofitBuilder
import com.example.imdb.retrofit.tmdbApi.RetrofitBuilder
import com.example.imdb.tmdbapidataclass.MailerooResponse
import com.example.imdb.tmdbapidataclass.Movie.MovieCreditsdata
import com.example.imdb.tmdbapidataclass.Movie.MovieDetailsData
import com.example.imdb.tmdbapidataclass.Movie.MovieLinks
import com.example.imdb.tmdbapidataclass.Movie.MovieReleaseDateAndCertification
import com.example.imdb.tmdbapidataclass.Movie.MovieVideosData
import com.example.imdb.tmdbapidataclass.Movie.PopularTopRatedTrendingOnTheAirMoviesData
import com.example.imdb.tmdbapidataclass.Series.PopularTopRatedTrendingOnTheAirSeriesData
import com.example.imdb.tmdbapidataclass.Series.SeriesCreditsOneData
import com.example.imdb.tmdbapidataclass.Series.SeriesDetailsOneData
import com.example.imdb.tmdbapidataclass.Series.SeriesVideosOneData

class TMDBRepository {
   val maileroo_api_key = "a9be8e697efa01f7b105f598a24c3216ecd2a236f8333650111b4cff3ac60b45"
    val tmdb_api_key = "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJhMDk2YzkyOWFhZmQ5YzI2MmM1NzJlZTUyZjBkMWNkZSIsIm5iZiI6MTc1NDI1MjAyNy43MzYsInN1YiI6IjY4OGZjMmZiNTM4NjIyNDVkYTExZGQ3NSIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.iv2s4qfc8LIrf1bZ5FwQCCouaZYhN6ex1sDb8cX-VaI"
